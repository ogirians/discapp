		...
		<div class="card-body px-lg-5 pt-4">
			<form action="{{url('/test')}}" method="post">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="number" value="{{old('kode')}}" class="form-control" name="kode" placeholder="room code">
						@if($errors->has('kode'))<span class="help-block" style="color: red;">{{ ucfirst($errors->first('kode')) }}</span>@endif
					</div>
				</div>
				<div class="form-group row">
